...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['marketplace_account', 'marketplace_inventory_feed', 'marketplace_return_case', 'external_fulfillment_order'], 'action_targets': {'create': None, 'transmit': None, 'accept': None, 'fulfill': None, 'flag_exception': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
