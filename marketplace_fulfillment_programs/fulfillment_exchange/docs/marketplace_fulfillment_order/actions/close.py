"""Action handler seed for marketplace_fulfillment_order:close."""
...
ACTION_ID = "close"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'transmitted', 'accepted', 'fulfilled', 'exception'], 'transitions_to': 'closed'}
...
ACTION_CONTRACT: dict[str, Any] = {'rule': {'allowed_in_states': ['draft', 'transmitted', 'accepted', 'fulfilled', 'exception'], 'transitions_to': 'closed'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}
