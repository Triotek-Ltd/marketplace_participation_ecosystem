"""Action handler seed for marketplace_inventory_feed:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['created', 'transmitted', 'accepted', 'failed'], 'transitions_to': 'archived'}
