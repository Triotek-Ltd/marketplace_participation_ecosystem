"""Action handler seed for marketplace_return_case:escalate."""
...
ACTION_ID = "escalate"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['requested', 'reviewed', 'approved', 'rejected', 'completed', 'escalated'], 'transitions_to': 'escalated'}
