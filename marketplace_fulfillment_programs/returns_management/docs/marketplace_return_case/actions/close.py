"""Action handler seed for marketplace_return_case:close."""
...
ACTION_ID = "close"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['requested', 'reviewed', 'approved', 'rejected', 'completed', 'escalated'], 'transitions_to': 'closed'}
