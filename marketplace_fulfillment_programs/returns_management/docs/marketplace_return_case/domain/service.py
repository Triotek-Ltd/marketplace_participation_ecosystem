...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['marketplace_fulfillment_order', 'listing_binding', 'refund_case', 'delivery_exception_case'], 'action_targets': {'create': None, 'review': 'reviewed', 'approve': 'approved', 'reject': 'rejected', 'complete': None, 'escalate': 'escalated', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
