"""Relation service seed for campaign_performance_snapshot."""
...
RELATED_DOCS = [{'doc_id': 'marketplace_campaign', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sponsored_listing_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'campaign_result', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'campaign identity'}, {'description': 'spend context from marketplace_campaign'}]
