...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['marketplace_account', 'sponsored_listing_record', 'campaign_performance_snapshot'], 'action_targets': {'create': None, 'review': None, 'approve': 'approved', 'launch': None, 'pause': None, 'close': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
