...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'onboarding_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'case_code', 'target_marketplace', 'applicant_scope'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'in_review', 'approved', 'rejected', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'approve': 'approved', 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}}
