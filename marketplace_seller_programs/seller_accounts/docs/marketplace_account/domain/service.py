"""Business-domain service seed for Marketplace Account."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['seller_onboarding_case', 'listing_binding', 'marketplace_campaign'], 'action_targets': {'create': None, 'activate': 'active', 'suspend': None, 'archive': 'archived'}, 'action_side_effects_file': None}

class DomainService:
    doc_id = "marketplace_account"
    archetype = "master"
    doc_kind = "master"
