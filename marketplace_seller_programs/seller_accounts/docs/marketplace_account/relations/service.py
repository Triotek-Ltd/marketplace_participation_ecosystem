"""Relation service seed for marketplace_account."""
...
RELATED_DOCS = [{'doc_id': 'seller_onboarding_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'listing_binding', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'marketplace_campaign', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'marketplace program context from onboarding/config records'}]
