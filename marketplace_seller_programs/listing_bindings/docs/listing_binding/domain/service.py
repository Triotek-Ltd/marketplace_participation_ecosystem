...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['marketplace_account', 'marketplace_fulfillment_order', 'sponsored_listing_record', 'catalog_product'], 'action_targets': {'create': None, 'sync': None, 'activate': 'active', 'suspend': None, 'delist': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
